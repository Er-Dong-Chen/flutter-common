...
class ComCheckbox extends StatefulWidget {
  ...
  @override
  State<ComCheckbox> createState() => _CheckboxState();
}

class _CheckboxState extends State<ComCheckbox>
    with TickerProviderStateMixin, ToggleableStateMixin {
  // final _CheckboxPainter _painter = _CheckboxPainter(widget.offset);
  late final _CheckboxPainter _painter;
  bool? _previousValue;
  ...
  void initState() {
    ...
    _painter = _CheckboxPainter(widget.offset);
  }

  @override
  void didUpdateWidget(ComCheckbox oldWidget) {
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    // 将画布移动到原点位置
    canvas.translate(origin.dx * 0.4 + offset.dx, origin.dy * 0.4 + offset.dy);
