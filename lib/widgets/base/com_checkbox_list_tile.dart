...
import 'com_checkbox.dart';

enum _CheckboxType { material, adaptive }

class ComCheckboxListTile extends StatelessWidget {
  ...
  ///
  /// The checkbox uses [ComCheckbox.adaptive] to show a [CupertinoCheckbox] for
  /// iOS platforms, or [ComCheckbox] for all others.
  ///
  ...
  ///
  /// The given value is passed directly to [ComCheckbox.side].
  ///
  ...
  ///
  /// This value will surround the [ComCheckbox], [title], [subtitle], and [secondary]
  /// widgets in [ComCheckboxListTile].
  ///
  ...
  ///
  /// ComCheckbox displays a dash when its value is null.
  ///
  ...
  /// If non-null, defines the background color when [ComCheckboxListTile.selected] is true.
  ...
  /// Whether the ComCheckboxListTile is interactive.
  ///
